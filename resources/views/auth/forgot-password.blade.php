...
<head>
  ...
  <title>Lupa Password - Muhammad Rafli Eriyanto</title>
  ...
  <style>
    ...
    .btn-primary {
      ...
      box-shadow: 0px -0.4em 0px 0px rgba(34, 36, 38, 0.15) inset;
      padding: 10px 20px;
      font-size: 18px;
    }
    ...
    <div class="card border-0 shadow">
      ...
      <div class="text-left mt-4">
        <div class="form-group mx-auto mb-0">
          <a class="text-black font-weight-bold regStr" href="{{ route('login') }}">Kembali ke Login</a>
        </div>
      </div>
    </div>
  </div>
